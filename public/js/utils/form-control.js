function createLoadingAnimation(message, color = 'blue') {
    ...
    return `
        <svg aria-hidden="true" class="w-5 h-5 text-gray-200 animate-spin dark:text-gray-600 ${colors[color]['fill']}" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
