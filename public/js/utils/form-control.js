function createLoadingAnimation(message){
    ...
    loading.setAttribute('class', 'loading flex items-center justify-center space-x-2 text-sm text-gray-200 dark:text-gray-600');
    loading.innerHTML = `
        ...
        <span class="text-upbg font-medium">${message || 'Loading...'}</span>
        `;
