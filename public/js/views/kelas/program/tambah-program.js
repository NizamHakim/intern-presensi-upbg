...
function playFetchingAnimation(form){
    ...
    loading.setAttribute('class', 'button-loading flex flex-row items-center justify-center font-semibold px-4 py-2 border border-green-600 bg-white rounded-md cursor-progress');
