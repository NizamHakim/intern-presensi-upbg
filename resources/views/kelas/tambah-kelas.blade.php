<x-layouts.user-layout>
    ...
    <form action="{{ route('kelas.store') }}" class="tambah-kelas-form flex flex-col bg-white p-6 shadow-sm mt-6">
        ...
        <div class="flex flex-col input-group mt-4">
            ...
            <input type="text" name="group-link" class="input-style" placeholder="https://chat.whatsapp.com/">
        </div>
