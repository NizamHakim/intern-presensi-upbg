    ...
    <div class="size-full flex flex-col justify-center items-center">
        <div class="w-full max-w-md px-6 flex flex-col justify-center items-center gap-10">
            ...
            <form action="{{ route('auth.handleLoginRequest') }}" method="POST" class="flex flex-col w-full gap-8">
                ...
                <button type="submit" class="w-full h-12 rounded-md text-white shadow-lg bg-upbg transition duration-300 hover:bg-upbg-dark"><i class="fa-solid fa-arrow-right-to-bracket"></i> Login</button>
            </form>
        </div>
    </div>
</x-layouts.public-layout>