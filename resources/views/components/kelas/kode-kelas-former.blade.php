<div class="flex flex-col col-span-full input-group">
    ...
    <input name="kode-kelas" value="{{ ($kelas) ? $kelas->kode : null }}" readonly type="text" placeholder="Isi kolom dibawah untuk membuat kode kelas" class="input-style truncate">
</div>
...
<section id="kode-kelas-section" class="grid grid-cols-6 gap-x-3 gap-y-4">
    ...
    <div class="input-group col-span-full kode-former md:col-span-3 xl:col-span-2">
        ...
        <input type="number" name="nomor-kelas" value="{{ ($kelas) ? $kelas->nomor_kelas : null }}" class="input-style input-number" placeholder="Nomor kelas">
    </div>
    ...
    <div class="input-group col-span-full kode-former md:col-span-3 xl:col-span-2">
        ...
        <input type="number" name="banyak-pertemuan" value="{{ ($kelas) ? $kelas->banyak_pertemuan : null }}" class="input-style input-number" placeholder="Banyak pertemuan">
    </div>
